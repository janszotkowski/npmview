...
export const SearchResults: React.FC<SearchResultsProps> = (props): React.ReactElement => {
    ...
    return (
        <div
            className={`w-full text-left ${props.className || ''} mx-auto bg-white/80 dark:bg-neutral-900/80 backdrop-blur-xl border border-neutral-200 dark:border-neutral-800 rounded-2xl shadow-2xl p-4 max-h-[60vh] overflow-y-auto scrollbar-thin scrollbar-thumb-neutral-200 dark:scrollbar-thumb-neutral-800 overscroll-contain`}
        >
