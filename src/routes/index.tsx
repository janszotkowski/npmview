...
function Home() {
    ...
    return (
        <div className={'flex flex-col items-center min-h-screen relative overflow-x-hidden'}>
            <div className={'absolute top-0 left-1/2 -translate-x-1/2 w-full h-150 bg-linear-to-b from-red-100/80 to-transparent dark:from-red-900/20 dark:to-transparent pointer-events-none blur-3xl'}/>
